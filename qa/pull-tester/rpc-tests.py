...
`qa/pull-tester/test_framework/test_framework.py:BethelTestFramework.main`.
...
#Set env vars
if "BETHELD" not in os.environ:
    os.environ["BETHELD"] = BUILDDIR + '/src/betheld' + EXEEXT
if "BETHELCLI" not in os.environ:
    os.environ["BETHELCLI"] = BUILDDIR + '/src/bethel-cli' + EXEEXT

if EXEEXT == ".exe" and "-win" not in opts:
    # https://github.com/bethel/bethel/commit/d52802551752140cf41f0d9a225a43e84404d3e9
    # https://github.com/bethel/bethel/pull/5677#issuecomment-136646964
    print("Win tests currently disabled by default.  Use -win option to enable")
    sys.exit(0)

if not (ENABLE_WALLET == 1 and ENABLE_UTILS == 1 and ENABLE_BETHELD == 1):
    print("No rpc tests to run. Wallet, utils, and betheld must all be enabled")
    sys.exit(0)
...
class RPCCoverage(object):
    ...
    commands per `bethel-cli help` (`rpc_interface.txt`).
