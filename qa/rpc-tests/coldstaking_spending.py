...
class ColdStakingSpending(BethelTestFramework):
    ...
    def run_test(self):
        ...
        # get wallet balance and staking weight before sending some bethel
        ...
        """send bethel to our coldstaking address, grab balance & staking weight"""

        # send funds to the cold staking address (leave some btel for fees) -- we specifically require
        # a transaction fee of minimum 0.002884 bethel due to the complexity of this transaction
        ...
        # asserts if amount recieved is what it should be; ~59814699.99660530 BTEL
        ...
        # staking weight will be 0 as our recieved BLOCK_REWARD bethel isn't mature enough to count towards
        # our staking weight
