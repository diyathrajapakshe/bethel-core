...
class GetStakeReport(BethelTestFramework):
    ...
    def run_test(self):
        ...
        # Send funds to the spending address (leave some BTEL for fees)
        ...
        # Make sure we have staked 2 BTEL to the spending address
        ...
        # Send funds to the cold staking address (leave some BTEL for fees)
        ...
        # Make sure we staked 4 BTEL in spending address (2 BTEL via COLD Stake)
        # So that means spending last 24h == 4
        # And staking last 24h == 2 We stake 2 BTEL via COLD already
        # And merged will have the total of the spending + staking
