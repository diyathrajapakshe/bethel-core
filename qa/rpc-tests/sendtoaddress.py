...
class SendToAddressTest (BethelTestFramework):
    ...
    def run_test (self):
        ...
        # Generate necessary BTEL for transactions
        print("Mining blocks...")
        ...
        # Assert correct amount of BTEL generated
        ...
        try:
            ...
            if "Invalid Bethel address" in e.error["message"]:
        ...
        try:
            ...
            if "Insufficient funds" in e.error["message"]:
                exception_assert = True
                # Not enought BTEL to make transaction
        assert(exception_assert)
        exception_assert = False
        try:
            ...
            if "Error: This transaction requires a transaction fee of at least 0.0001 because of its amount, complexity, or use of recently received funds!" in e.error["message"]:
                exception_assert = True
                # Try send entire balance, not enought BTEL to pay for fee
        assert(exception_assert)
        exception_assert = False
        try:
