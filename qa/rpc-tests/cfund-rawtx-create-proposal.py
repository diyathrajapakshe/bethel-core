...
class CommunityFundRawTXCreateProposalTest(BethelTestFramework):
    ...
    def __init__(self):
        ...
        self.goodDescription = "these are not the BTEL Droids you are looking for"
    ...
    def run_test(self):
        ...
        self.test_invalid_proposal("NPyEJsv82GaguVsY3Ur4pu4WwnFCsYQ94g", self.goodAmount, self.goodDuration, "I should not work") # btel address we don't own
