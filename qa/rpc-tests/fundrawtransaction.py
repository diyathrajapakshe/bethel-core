...
class RawTransactionsTest(BethelTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid bethel address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid bethel address" in e.error['message'])
