...
class WalletTest (BethelTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 BTEL from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 BTEL with subtract fee from amount
        ...
        # Sendmany 10 BTEL with subtract fee from amount
        ...
        #     '-zapwallettxes=1',
        #     '-zapwallettxes=2',
        #     # disabled until issue is fixed: https://github.com/bethel/bethel/issues/7463
        #     # '-salvagewallet',
        # ]
