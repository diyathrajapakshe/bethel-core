...
class CommunityFundCreatePaymentrequestRawTX(BethelTestFramework):
...
#            assert ("bad-cfund-payment-request" in e.error['message'])
    ...
    def send_raw_paymentrequest(self, amount, address, proposal_hash, description):
        ...
        message = "I kindly ask to withdraw " + str(amount) + "BTEL from the proposal " + proposal_hash + ". Payment request id: " + str(description)
