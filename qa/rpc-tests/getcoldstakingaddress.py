...
class GetColdStakingAddress(BethelTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            assert("Staking address is not a valid Bethel address" in e.error['message'])

        try:
            self.nodes[0].getcoldstakingaddress(address_one, coldstaking_address_one)
            make_addr_fail = False
        except JSONRPCException as e:
            assert("Spending address is not a valid Bethel address" in e.error['message'])
        ...
        try:
            ...
            assert(("getcoldstakingaddress \"stakingaddress\" \"spendingaddres"
                ...
                "bethel staking address.\n2. \"spendingaddress\" (string, req"
                "uired) The bethel spending address.\n\n\nExamples:\n> bethe"
                "l-cli getcoldstakingaddress \"mqyGZvLYfEH27Zk3z6JkwJgB1zpjaEH"
