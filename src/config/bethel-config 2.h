/* src/config/bethel-config.h.  Generated from bethel-config.h.in by configure.  */
/* src/config/bethel-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BETHEL_CONFIG_H

#define BETHEL_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Bethel Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Bethel Core"
...
#define PACKAGE_BUGREPORT "https://github.com/bethel/bethel-core/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Bethel Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bethel Core 4.6.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bethel"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://bethel.org/"
