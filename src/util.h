 ...
 */
#ifndef BETHEL_UTIL_H
#define BETHEL_UTIL_H
...
extern const char * const BETHEL_CONF_FILENAME;
extern const char * const BETHEL_PID_FILENAME;
...
{
    std::string s = strprintf("bethel-%s", name);
