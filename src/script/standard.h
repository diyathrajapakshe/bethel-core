...
#ifndef BETHEL_SCRIPT_STANDARD_H
#define BETHEL_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a CBethelAddress
 */
...
#endif // BETHEL_SCRIPT_STANDARD_H
