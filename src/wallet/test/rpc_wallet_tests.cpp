...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CBethelAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CBethelAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CBethelAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CBethelAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CBethelAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CBethelAddress(arr[0].get_str()).Get() == demoAddress.Get());
