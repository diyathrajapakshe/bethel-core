...
#ifndef BETHEL_TEST_SCRIPTNUM10_H
#define BETHEL_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bethel Core 0.10.0, for cross-comparison.
 */
public:
