...
#define BOOST_TEST_MODULE Bethel Test Suite

#include "test_bethel.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_bethel_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
