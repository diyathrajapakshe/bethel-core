...
public:
    TxViewDelegate(const PlatformStyle *platformStyle):
        QAbstractItemDelegate(), unit(BethelUnits::BTEL),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        QString amountText = BethelUnits::formatWithUnit(unit, amount, true, BethelUnits::separatorAlways);
        if(!confirmed)
        {
                              ...
                              const CAmount& coldStakingBalance)
{
    ...
    ui->labelBalance->setText(BethelUnits::formatWithUnit(unit, balance, false, BethelUnits::separatorAlways));
    ui->labelUnconfirmed->setText(BethelUnits::formatWithUnit(unit, unconfirmedBalance, false, BethelUnits::separatorAlways));
    ui->labelStaking->setText(BethelUnits::formatWithUnit(unit, stakingBalance, false, BethelUnits::separatorAlways));
    ui->labelColdStaking->setText(BethelUnits::formatWithUnit(unit, coldStakingBalance, false, BethelUnits::separatorAlways));
    ui->labelImmature->setText(BethelUnits::formatWithUnit(unit, immatureBalance, false, BethelUnits::separatorAlways));
    ui->labelWatchedBalance->setText(BethelUnits::formatWithUnit(unit, currentWatchOnlyTotalBalance, false, BethelUnits::separatorAlways));
    ui->labelTotal->setText(BethelUnits::formatWithUnit(unit, currentTotalBalance + currentWatchOnlyTotalBalance, false, BethelUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("BTEL")
    updateDisplayUnit();
}
...
void OverviewPage::updateStakeReport(bool fImmediate=false)
{
    ...
    ui->label24hStakingStats->setText(BethelUnits::formatWithUnit(unit, aRange[i++].Total, false, BethelUnits::separatorAlways));
    ui->label7dStakingStats->setText(BethelUnits::formatWithUnit(unit, aRange[i++].Total, false, BethelUnits::separatorAlways));
    ui->label30dStakingStats->setText(BethelUnits::formatWithUnit(unit, aRange[i++].Total, false, BethelUnits::separatorAlways));
    ui->label1yStakingStats->setText(BethelUnits::formatWithUnit(unit, aRange[i++].Total, false, BethelUnits::separatorAlways));
    ui->labelallStakingStats->setText(BethelUnits::formatWithUnit(unit, aRange[i++].Total, false, BethelUnits::separatorAlways));
}
