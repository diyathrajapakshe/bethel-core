...
void OptionsModel::Init(bool resetSettings)
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BethelUnits::BTEL);
    nDisplayUnit = settings.value("nDisplayUnit").toInt();

    if (!settings.contains("strThirdPartyTxUrls"))
        settings.setValue("strThirdPartyTxUrls", "https://www.btelexplorer.com/tx/%s");
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "https://www.btelexplorer.com/tx/%s").toString();
...
void OptionsModel::checkAndMigrate()
{
    ...
    if (settingsVersion < CLIENT_VERSION)
    {
        ...
        // see https://github.com/bethel/bethel/pull/8273
