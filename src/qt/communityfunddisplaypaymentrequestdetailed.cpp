...
void CommunityFundDisplayPaymentRequestDetailed::setPrequestLabels() const
{
    ...
    // Link
    ui->labelPrequestLink->setText(QString::fromStdString("https://www.btelexplorer.com/community-fund/payment-request/" + prequest.hash.ToString()));
    ...
    //set hyperlink for btelcommunity proposal view
