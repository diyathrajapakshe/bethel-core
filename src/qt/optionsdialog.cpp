    ...
    mapper(0)
{
    ...
    ui->bethelAtStartup->setToolTip(ui->bethelAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->bethelAtStartup->setText(ui->bethelAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->thirdPartyTxUrls->setPlaceholderText("https://www.btelexplorer.com/tx/%s");

    ui->unit->setModel(new BethelUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bethelAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBethelConfButton_clicked()
{
