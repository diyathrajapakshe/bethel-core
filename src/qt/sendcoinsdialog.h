...
#ifndef BETHEL_QT_SENDCOINSDIALOG_H
#define BETHEL_QT_SENDCOINSDIALOG_H
...
public Q_SLOTS:
    ...
    void checkBteltechServers();
    void showBtelTechDialog();
...
#endif // BETHEL_QT_SENDCOINSDIALOG_H
