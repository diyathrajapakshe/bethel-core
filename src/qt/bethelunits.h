...
#ifndef BETHEL_QT_BETHELUNITS_H
#define BETHEL_QT_BETHELUNITS_H
...
/** Bethel unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BethelUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BethelUnits(QObject *parent);

    /** Bethel units.
      @note Source: https://en.bethel.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTEL,
...
typedef BethelUnits::Unit BethelUnit;

#endif // BETHEL_QT_BETHELUNITS_H
