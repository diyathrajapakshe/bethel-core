...
#ifndef BETHEL_QT_WALLETFRAME_H
#define BETHEL_QT_WALLETFRAME_H
...
public:
    explicit WalletFrame(const PlatformStyle *platformStyle, BethelGUI *_gui = 0);
    ~WalletFrame();
