    ...
    prequest(0)
{
    ...
    ui->label->setText(QString::fromStdString("You can now view your proposal in the core wallet or <a href=\"https://www.btelexplorer.com/community-fund/proposals/pending\">on the btelexplorer</a> once the next block has been broadcast"));
    ...
    prequest(prequest)
{
    ...
    ui->label->setTextFormat(Qt::RichText);
    ui->label->setText(QString::fromStdString("You can now view your payment request in the core wallet or <a href=\"https://www.btelexplorer.com/community-fund/payment-requests/pending\">on the btelexplorer</a> once the next block has been broadcast"));
    ui->label->setTextInteractionFlags(Qt::TextBrowserInteraction);
    ui->label->setOpenExternalLinks(true);
}
