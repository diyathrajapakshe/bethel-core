...
### Community Fund - Accumulation of coins, signaled by version bit 7:
  ...
  - Inclusion of an additional output in the Coinstake transaction contributing 0.25BTEL to the Community Fund
...
- Accepts URI to sign messages.
    - URIs of the format bethel:http://domain/something/?a=bethel_address&m=some_message will make the wallet to sign “some_message” and return the produced signature as a POST request to the URL specified in the URI.
...
- bethel-tx tool has been updated to use bethel’s own transaction structure
