...
- Fee to create a Proposal: 50 BTEL
...
You can read more about [NPIP0003 on the NPIP GitHub](https://github.com/bethel/npips/blob/master/npip-0003.mediawiki).

## Community Fund Contribution Increase

The Version Bit 16 will signal for the soft fork to increase the Community Fund contribution from 0.25 BTEL to 0.50 BTEL per block. 

You can read more about [NPIP0005 on the NPIP GitHub](https://github.com/bethel/npips/blob/master/npip-0005.mediawiki).
...
```
createproposal betheladdress amount duration "desc" fee

Arguments:
1. "betheladdress" (string, required) The bethel address where coins would be sent if the proposal is approved.
2. "amount" The amount in BTEL to request. eg 100
...
2. "amount" (numeric or string, required) The amount in BTEL to withdraw. eg 10
...
Donate BTEL from your wallet to the commnuity fund

Arguments:
1. "amount" (string, required) The amount of BTEL to donate
```
