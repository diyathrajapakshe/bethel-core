...
This document provides guidelines for internationalization of the Bethel Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bethel_en.ts` remains unchanged.
